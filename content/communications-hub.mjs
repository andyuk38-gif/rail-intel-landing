        ...
        <div class="comm-hub-shots">
          <figure class="shot reveal">
            <div class="shot__frame">
              <img src="${base}images/screens/messaging-employee/employee-messaging.png" alt="Messaging threads held against the employee record." width="519" height="621" loading="lazy" decoding="async" />
            </div>
