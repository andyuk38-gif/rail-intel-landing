...
function renderShare(base) {
  return `<div class="share" data-share>
          <button type="button" class="share__toggle" data-share-toggle aria-expanded="false" aria-controls="share-panel">
            <span class="share__brands" aria-hidden="true">
              <span class="share__brand share__brand--linkedin">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M6.5 9H4V20h2.5V9zM5.2 4.2A1.6 1.6 0 1 0 5.2 7.4 1.6 1.6 0 0 0 5.2 4.2zM20 20h-2.5v-5.6c0-1.6-.6-2.6-2-2.6-1 0-1.6.7-1.9 1.3-.1.2-.1.6-.1.9V20H11V9h2.4v1.5c.4-.7 1.3-1.8 3.2-1.8 2.3 0 4 1.5 4 4.8V20z"/></svg>
              </span>
              <span class="share__brand share__brand--whatsapp">
                <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12.04 4C7.6 4 4 7.5 4 11.84c0 1.38.37 2.72 1.08 3.9L4 20l4.4-1.14a8.1 8.1 0 0 0 3.64.86h.01c4.44 0 8.05-3.5 8.05-7.84C20.1 7.5 16.48 4 12.04 4zm4.7 11.1c-.2.56-1.16 1.03-1.6 1.08-.42.05-.94.08-1.52-.1-.35-.1-.8-.26-1.38-.51-2.43-1.05-4.01-3.5-4.13-3.66-.12-.16-1-1.33-1-2.54s.63-1.8.86-2.05c.22-.24.49-.3.65-.3h.47c.15 0 .35-.06.55.42.2.5.68 1.72.74 1.84.06.12.1.27.02.43-.08.16-.12.26-.24.4-.12.14-.25.31-.36.42-.12.12-.24.24-.1.47.14.24.62 1.02 1.33 1.65.92.82 1.69 1.07 1.93 1.19.24.12.38.1.52-.06.14-.16.6-.7.76-.94.16-.24.32-.2.54-.12.22.08 1.4.66 1.64.78.24.12.4.18.46.28.06.1.06.58-.14 1.14z"/></svg>
              </span>
            </span>
                ...
                <div class="medicals-licensing-hero-graphic__card-wrap">
                  ...
                  <div class="medicals-licensing-hero-graphic__monitor">
                    <div class="medicals-licensing-hero-graphic__monitor-head">
                      <span class="medicals-licensing-hero-graphic__monitor-label">
                        <svg class="medicals-licensing-hero-graphic__monitor-heart" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                          <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
                        </svg>
                        ECG Scanning - Aligning with Standard
                      </span>
                      <span class="medicals-licensing-hero-graphic__monitor-bpm"><span class="medicals-licensing-hero-graphic__monitor-bpm-value">72</span> BPM</span>
                    </div>
                    <div class="medicals-licensing-hero-graphic__monitor-screen">
                      <div class="medicals-licensing-hero-graphic__monitor-grid"></div>
                      <svg class="medicals-licensing-hero-graphic__monitor-trace" viewBox="0 0 480 64" preserveAspectRatio="none" aria-hidden="true">
                        <path d="M0 32 H36 L44 10 L52 54 L60 22 L68 42 L76 32 H124 L132 8 L140 56 L148 18 L156 46 L164 32 H212 L220 12 L228 52 L236 24 L244 40 L252 32 H300 L308 6 L316 58 L324 16 L332 48 L340 32 H388 L396 14 L404 50 L412 26 L420 38 L428 32 H480" />
                      </svg>
                      <div class="medicals-licensing-hero-graphic__monitor-cursor"></div>
                    </div>
                  </div>
                </div>
              </div>
