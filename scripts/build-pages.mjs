...
${getStarted.procurementNotice.items.map((item) => `            <li>${esc(item)}</li>`).join("\n")}
        ...
        <div class="signup-wizard-glass" data-cms-signup-wizard>
          ...
          <ol class="signup-wizard__steps signup-wizard__steps--6" data-signup-stepper aria-label="Application progress">
            ...
            <li class="signup-wizard__step" data-signup-step-indicator="2"><span class="signup-wizard__step-num">2</span> Current setup</li>
            <li class="signup-wizard__step" data-signup-step-indicator="3"><span class="signup-wizard__step-num">3</span> Contact</li>
            <li class="signup-wizard__step" data-signup-step-indicator="4"><span class="signup-wizard__step-num">4</span> Path</li>
            <li class="signup-wizard__step" data-signup-step-indicator="5"><span class="signup-wizard__step-num">5</span> Addon modules</li>
          ...
          <div class="signup-wizard__body" data-signup-panel="purchase-pay" hidden>
            ...
            <div data-signup-bank-panel hidden>
              <h2 class="signup-form__title">Bank transfer &amp; PO</h2>
              <p class="signup-form__lead">Upload your purchase order and pay using the details below.</p>
