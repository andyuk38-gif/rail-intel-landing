...
/* The sprite already draws the sloped cab in alpha. Extra lofted faces were
   standing proud of that silhouette, so the ends are now just a tapered hood
   on the roof-line and a small rounded cone at the tip. */
function railSet() {
  return `<div class="rail-set">
                      <span class="rail-set__side rail-set__side--far"></span>
                      <span class="rail-set__roof"></span>
                      <span class="rail-set__hood rail-set__hood--far"></span>
                      <span class="rail-set__hood rail-set__hood--near"></span>
                      <span class="rail-set__fill rail-set__fill--far">
                        <i style="left:calc(2.85 * var(--m));top:calc(0.38 * var(--m));width:calc(1.7 * var(--m));height:calc(3.37 * var(--m))"></i>
                        <i style="left:calc(2.10 * var(--m));top:calc(0.82 * var(--m));width:calc(1.25 * var(--m));height:calc(1.95 * var(--m))"></i>
                        <i style="left:calc(1.43 * var(--m));top:calc(1.20 * var(--m));width:calc(0.85 * var(--m));height:calc(2.18 * var(--m))"></i>
                        <i style="left:calc(0.75 * var(--m));top:calc(1.80 * var(--m));width:calc(0.45 * var(--m));height:calc(1.65 * var(--m))"></i>
                      </span>
                      <span class="rail-set__fill rail-set__fill--near">
                        <i style="left:calc(64.80 * var(--m));top:calc(0.45 * var(--m));width:calc(1.7 * var(--m));height:calc(3.30 * var(--m))"></i>
                        <i style="left:calc(65.55 * var(--m));top:calc(0.90 * var(--m));width:calc(1.25 * var(--m));height:calc(1.95 * var(--m))"></i>
                        <i style="left:calc(66.23 * var(--m));top:calc(1.27 * var(--m));width:calc(0.85 * var(--m));height:calc(2.18 * var(--m))"></i>
                        <i style="left:calc(66.90 * var(--m));top:calc(1.88 * var(--m));width:calc(0.45 * var(--m));height:calc(1.65 * var(--m))"></i>
                      </span>
                      <span class="rail-set__cone rail-set__cone--far"></span>
                      <span class="rail-set__cone rail-set__cone--near">
